...
const App = () => {
  ...
  return (
    <section>
      ...
      <p>
        You only need to provide an unique <code>signalKey</code> for each
        request and <code>strong-fetch</code> will do the rest :). No more
        creating <code>AbortController</code> instances everywhere in your code.
      </p>
      <p>
      ...
      <a
        href="https://github.com/ivanatias/strong-fetch"
        target="_blank"
        rel="noreferrer noopener"
      >
        Github repository
